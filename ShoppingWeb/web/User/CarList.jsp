...
<body class="header_sticky header-style-2 has-menu-extra">
    				...
    				<div class="col-md-12">
    					...
    					<div class="breadcrumbs">
    						<ul>
                                ...
                                <li><a href="../shop.html">Fullwidth Shop</a></li>
    						</ul>
    					</div><!-- /.breadcrumbs -->
    				</div><!-- /.col-md-12 -->
    			</div><!-- /.row -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="product-content product-threecolumn clearfix">
                            ...
                            <p id="mess" style="color: red;text-align: center"></p>
                        </div><!-- /.product-content -->
    ...
    <script src="../javascript/private/CartList.js"></script>
</body> 
</html>                               
