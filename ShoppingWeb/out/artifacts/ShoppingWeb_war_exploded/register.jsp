                    ...
                    <div class="subscribe clearfix">
                        <form action="login()" method="post" accept-charset="utf-8" id="subscribe-form">
                            <div class="subscribe-content">
                                ...
                                <div class="input">
                                    <input type="password" id="repass" name="repass" placeholder="Your password">
                                </div>
                                <div class="default">
                                ...
                                <div class="button">
                                    <button type="button" onclick="register()">SUBCRIBE</button>
                                </div>
...
<script src="javascript/private/register.js"></script>
</body>
</html>                               
