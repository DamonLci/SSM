                ...
                <div class="nav-wrap">
                    <nav id="mainnav" class="mainnav">
                        <ul class="menu">
                            ...
                            <li><a href="CarList.jsp">CarList</a></li>
                            <li><a href="../login.jsp">login</a>
                            <li><a href="ModifyPass.jsp">ModifyPass</a></li>
                        </ul>
                    </nav><!-- /.mainnav -->
                </div><!-- /.nav-wrap -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="subscribe clearfix">
                        <form action="login()" method="post" accept-charset="utf-8" id="subscribe-form">
                            <div class="subscribe-content">
                                <div class="input">
                                    <input type="tel" id="pass" name="pass" placeholder="Your oldpass">
                                </div>
                                <div class="input">
                                    <input type="password" id="newpass" name="newpass" placeholder="Your newpass">
                                </div>
                                <div class="input">
                                    <input type="password" id="confnewpass" name="confnewpass" placeholder="Your newpass">
                                </div>
                                <div class="default">
...
<script src="../javascript/private/ModifPass.js"></script>
</body>
</html>                               
